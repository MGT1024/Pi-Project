...
def display_text():
    ...
    dealer_text_surf = text_font.render(f"Dealer Hand: {DEALER.card_vals}", False, (50, 205, 50))
    ...
    player_text_surf = text_font.render(f"Player Hand: {PLAYER.card_vals}", False, (50, 205, 50))
...
class Player(pygame.sprite.Sprite):
    ...
    def display_status(self):
        ...
        status_surf = text_font.render(f"Status: {self.status}", False, (50, 205, 50))
...
class StandButton(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("images/stand button.png").convert_alpha()
...
class HitButton(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("images/hit button.png").convert_alpha()
...
class Card(pygame.sprite.Sprite):
    ...
    def __init__(self, card_info, x_coord, y_coord, hidden=False):
        ...
        if self.hidden == True: self.image = pygame.image.load("images/cards/cardback.png") 

        else: self.image = pygame.image.load(f"images/cards/card{self.face}{self.suit}.png")
...
text_font = pygame.font.Font("font/LGGothic.ttf", 25)



# background

bg_img = pygame.image.load("images/blackjack background.png").convert_alpha()
